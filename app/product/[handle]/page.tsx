...
const demoProducts: Record<string, {
  ...
  'structured-wool-coat': {
    ...
    images: ['/images/runway-1.jpg', '/images/model-2.jpg'],
  ...
  'scarf-trench-coat': {
    ...
    images: ['/images/runway-1.jpg', '/images/flat-2.jpg'],
    colors: ['Beige', 'Black'],
    sizes: ['36', '38', '40', '42'],
  },
  'technical-nylon-tank': {
    ...
    images: ['/images/model-1.jpg', '/images/flat-1.jpg'],
    colors: ['Black'],
    sizes: ['36', '38', '40'],
  },
  'silk-turtleneck': {
    ...
    images: ['/images/model-3.jpg', '/images/flat-3.jpg'],
    colors: ['Black'],
    sizes: ['36', '38', '40'],
  },
}
